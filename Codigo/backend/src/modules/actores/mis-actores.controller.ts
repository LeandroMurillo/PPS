...
export async function listarMisActoresController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron listar tus actores culturales.');
	}
}
...
export async function obtenerOpcionesRegistroController(_req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron obtener las opciones de registro.');
	}
}
...
export async function obtenerFormulariosAplicablesController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron obtener los formularios aplicables.');
	}
}
...
export async function crearActorController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo crear el actor cultural.');
	}
}
...
export async function editarActorController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo modificar el actor cultural.');
	}
}
...
export async function obtenerFormulariosActorController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron obtener los formularios del actor.');
	}
}
...
export async function cambiarEstadoActorController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo cambiar el estado del actor.');
	}
}
...
export async function eliminarActorController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo eliminar el actor cultural.');
	}
}
...
export async function eliminarItemPortafolioController(req: Request, res: Response): Promise<void> {
	try {
		...
		res.json({ message: 'Elemento eliminado del portafolio.' });
	} catch (error) {
		sendControllerError(res, error, 'No se pudo eliminar el elemento del portafolio.');
	}
}
...
export async function listarPortafolioController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron listar los elementos del portafolio.');
	}
}
...
export async function agregarEventoController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo agregar el evento.');
	}
}
...
export async function listarEventosController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron listar los eventos.');
	}
}
...
export async function eliminarEventoController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo eliminar el evento.');
	}
}
...
export async function listarIntegrantesController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudieron listar los integrantes.');
	}
}
...
export async function agregarIntegranteController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo agregar el integrante.');
	}
}
...
export async function eliminarIntegranteController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo eliminar el integrante.');
	}
}
...
export async function editarIntegranteController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo modificar el integrante.');
	}
}
...
export async function transferirTitularidadController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo transferir la titularidad.');
	}
}
...
export async function renunciarIntegranteController(req: Request, res: Response): Promise<void> {
	try {
		...
		sendControllerError(res, error, 'No se pudo procesar la renuncia.');
	}
}
