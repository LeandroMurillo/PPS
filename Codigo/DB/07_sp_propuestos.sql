...
REPLACE
  PROCEDURE `sp_publico_listar_eventos` (
    ...
    IN pFechaDesde DATE DEFAULT NULL,
    IN pFechaHasta DATE DEFAULT NULL,
...
COMMENT 'Obtiene los contadores consolidados de impacto cultural para la portada institucional del portal. Resultsets: RS1: (totalActores, totalEspacios, totalDepartamentos, totalCategorias).'
BEGIN
  SELECT
...
-- ================================================================
-- GRUPO D: DIAGNOSTICO Y AUDITORIA DE INTEGRIDAD DEL SISTEMA
-- ================================================================
...
OR
REPLACE
  PROCEDURE `sp_sistema_auditar_integridad` () READS SQL DATA
COMMENT 'Ejecuta auditorias de integridad referencial y de negocio detectando anomalias o inconsistencias en la base de datos. Resultsets: RS1: (modulo, severidad, descripcion, idReferencia).'
BEGIN
  ...
  -- 2. Actores activos sin ningún integrante titular asignado
  INSERT INTO `tmp_auditoria_resultados` (modulo, severidad, descripcion, idReferencia)
  SELECT
    'ACTORES',
    'ALTA',
