...
INSERT INTO `cultura`.`MODERADORESCATEGORIAS` (`USUARIOS_idUSUARIO`, `CATEGORIAS_idCATEGORIA`) VALUES
(2, 1);
...
INSERT INTO `cultura`.`INTEGRANTES` (`USUARIOS_idUSUARIO`, `ACTORES_idACTORES`, `rol`) VALUES
...
INSERT INTO `cultura`.`ACTORESEVENTOS` (`EVENTOS_idEVENTO`, `ACTORES_idACTOR`) VALUES
...
INSERT INTO `cultura`.`CAMPOSFORMULARIOS` (`idCAMPO`, `CATEGORIAS_idCATEGORIA`, `tipoDato`, `esPublico`, `obligatorio`, `orden`, `pregunta`) VALUES
...
-- -----------------------------------------------------
INSERT INTO `cultura`.`RESPUESTASFORMULARIOS` (`idRESPUESTA`, `ACTORES_idACTOR`, `CAMPOSFORMULARIOS_idCAMPO`, `valor`) VALUES
...
-- -----------------------------------------------------
INSERT INTO `cultura`.`ITEMSPORTAFOLIO` (`idITEM`, `ACTORES_idACTOR`, `tipo`, `url`, `orden`, `descripcion`) VALUES
