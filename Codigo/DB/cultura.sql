...
CREATE TABLE IF NOT EXISTS `cultura`.`Actores` (
  ...
  PRIMARY KEY (`idActor`, `idSubcategoria`, `idCategoria`),
  INDEX `fk_Actores_Ubicaciones1_idx` (`idUbicacion` ASC) VISIBLE,
  INDEX `FK_Subcategorias_idSubcategoria1_idx` (`idSubcategoria` ASC, `idCategoria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cultura`.`Eventos` (
  ...
  `fechaCreacion` DATETIME NOT NULL,
  `estado` ENUM('A', 'I') NOT NULL,
  PRIMARY KEY (`idEvento`, `idActor`, `idSubcategoria`, `idCategoria`),
  INDEX `FK_Actores_idActor1_idx` (`idActor` ASC, `idSubcategoria` ASC, `idCategoria` ASC) VISIBLE,
  CONSTRAINT `FK_Actores_idActor1`
    FOREIGN KEY (`idActor` , `idSubcategoria` , `idCategoria`)
    REFERENCES `cultura`.`Actores` (`idActor` , `idSubcategoria` , `idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `cultura`.`ItemsPortafolio` (
  ...
  `orden` INT NULL,
  PRIMARY KEY (`idItem`, `idActor`, `idSubcategoria`, `idCategoria`),
  INDEX `FK_Actores_idActor3_idx` (`idActor` ASC, `idSubcategoria` ASC, `idCategoria` ASC) VISIBLE,
  CONSTRAINT `FK_Actores_idActor3`
    FOREIGN KEY (`idActor` , `idSubcategoria` , `idCategoria`)
    REFERENCES `cultura`.`Actores` (`idActor` , `idSubcategoria` , `idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `cultura`.`RespuestasCampo` (
  ...
  `idCategoria` INT NOT NULL,
  `valor` JSON NOT NULL,
  PRIMARY KEY (`idCampo`, `idActor`, `idSubcategoria`, `idCategoria`),
  INDEX `fk_CamposFormularios_has_Actores_CamposFormularios1_idx` (`idCampo` ASC) VISIBLE,
  INDEX `FK_Actores_idActor4_idx` (`idActor` ASC, `idSubcategoria` ASC, `idCategoria` ASC) VISIBLE,
  CONSTRAINT `fk_CamposFormularios_has_Actores_CamposFormularios1`
    FOREIGN KEY (`idCampo`)
    REFERENCES `cultura`.`CamposFormulario` (`idCampo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_Actores_idActor4`
    FOREIGN KEY (`idActor` , `idSubcategoria` , `idCategoria`)
    REFERENCES `cultura`.`Actores` (`idActor` , `idSubcategoria` , `idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `cultura`.`Postulaciones` (
  ...
  PRIMARY KEY (`idConvocatoria`, `idActor`, `idSubcategoria`, `idCategoria`),
  INDEX `FK_Convocatorias_idConvocatoria1_idx` (`idConvocatoria` ASC) VISIBLE,
  INDEX `FK_Actores_idActor2_idx` (`idActor` ASC, `idSubcategoria` ASC, `idCategoria` ASC) VISIBLE,
  CONSTRAINT `FK_Actores_idActor2`
    FOREIGN KEY (`idActor` , `idSubcategoria` , `idCategoria`)
    REFERENCES `cultura`.`Actores` (`idActor` , `idSubcategoria` , `idCategoria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
