...
-- Thu Jul  9 11:51:35 2026
-- Model: cultura    Version: 1.2.0
...
CREATE TABLE IF NOT EXISTS `cultura`.`Usuarios` (
  ...
  `actividadesArcaCodigo` CHAR(6) NULL,
  ...
  `registradoARCA` TINYINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `cultura`.`CamposFormulario` (
  ...
  `tipoDato` VARCHAR(45) NOT NULL COMMENT 'texto, numero, url.\n\n\'TEXTO_CORTO\',\n \'TEXTO_LARGO\',\n \'NUMERO\',\n \'FECHA\',\n \'BOOLEANO\',\n \'URL\',\n        \'EMAIL\',\n\'OPCION_UNICA\',\n\'OPCION_MULTIPLE\'',
  `pregunta` VARCHAR(500) NOT NULL,
  `opciones` JSON NULL COMMENT 'Para los multiple choice',
  PRIMARY KEY (`idCampo`))
ENGINE = InnoDB;
